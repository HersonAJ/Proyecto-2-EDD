...
import org.example.GUI.Vistas.AVLViewer;
import org.example.GUI.Vistas.BPlusViewer;
import org.example.GUI.Vistas.BViewer;
import org.example.GUI.Vistas.BusquedaUnificada;
...
public class MainWindow extends JFrame {
    ...
    private JTextArea lowWidget;

    private Object listadoAlfabetico;
    ...
    public MainWindow() {
        ...
        //panel log
        lowWidget = new JTextArea();
        lowWidget.setEditable(false);
        tabs.addTab("Log", new JScrollPane(lowWidget));

        //ventanas
        avlViewer = new AVLViewer(null);
    ...
    private void appendLog(String mensaje, String tipo) {
        // Aquí luego se implementará la lógica
    }
